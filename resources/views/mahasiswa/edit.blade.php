...
@section('content')
    ...
    <div class="form-group row">
        <label for="nim" class="col-sm-12">Nama Lengkao</label>
        <div class="col-sm-5">
        <input type="text" name="nama_lengkap" class="form-control" id="nama_lengkap" placeholder="Nama Tidak Boleh Kosong" value="{{ $mhs->nama_lengkap }}">
